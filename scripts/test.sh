...
ibmcloud doi publishtestrecord --filelocation='./coverage/supply-store/coverage-summary.json' --type=code --logicalappname="odr-mean-demo" --buildnumber="$BUILD_NUMBER"
